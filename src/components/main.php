...
<head>
    ...
    <div class="container cuerpo">
        <h1 class="center indigo-text darken-4">Bienvenido</h1>
        <div class="row">
                ...
                <div class="card transparent">
                    <div class="casilla">
                        <div class="row center">
                            <h4 class="indigo-text" >Memorama</h4>
                        ...
                        <div class="tabla-puntaje">
                            ...
                            ?>
                                <div class="row center">
                                    <div class="col s1"></div>
                                    <div class="col s1">
                                        <div class="tit2"><?= $cont ?></div>
                                    </div>
                                    <div class="col s6">
                                        <div class="tit2"><?= $row['nombre'] ?></div>
                                    </div>
                                    <div class="col s3">
                                        <div class="tit2"><?= $row['puntaje'] ?></div>
                                    </div>
                                    <div class="col s1"></div>
                                </div>
                            <?php
            ...
            <div class="col s12 l6">
                <div class="card transparent">
                    <div class="casilla">
                        <div class="row center">
                            <h4 class="indigo-text" >Cuestionario</h4>
                            <div class="col s1"></div>
                            <div class="col s1">
                                <div class="tit">#</div>
                            </div>
